...
define( 'SIMPLE_FLICKR_PLUGIN_URL', plugin_dir_url( __FILE__ ));
define( 'SIMPLE_FLICKR_PLUGIN_PATH', plugin_dir_path(__FILE__) );
define( 'SIMPLE_FLICKR_PLUGIN_BASENAME', plugin_basename(__FILE__));

//  Wrapped in after_setup_theme to utilize options
add_action('after_setup_theme', 'simple_flickr_plugin_init');
function simple_flickr_plugin_init(){

    //  Load class
    require_once( SIMPLE_FLICKR_PLUGIN_PATH . 'class-simple-flickr.php' );
